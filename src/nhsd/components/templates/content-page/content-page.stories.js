...
### Components used
- <a href="/docs/design-system-components-molecules-sticky-navigation--sticky-nav-component">Sticky Nav</a>

### Details
An example of the \`sticky-navigation\` component along side page content.

Content headers are given a unique \`id\` and referenced by sticky nav items with the \`data-nav-content\` attribute.`;

// Component defaults
export default {
    title: "Design System / Components / Templates / Content Page",
    parameters: {
      docs: {
        description: {

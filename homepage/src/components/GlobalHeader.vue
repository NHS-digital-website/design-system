<template>
  <header class="nhsd-o-global-header" id="nhsd-global-header">
    <div class="nhsd-t-grid">
        ...
        <div class="nhsd-t-col">
          <div class="nhsd-o-global-header__content-box">
            ...
            <div class="nhsd-o-global-header__logo-container">
              <span class="nhsd-m-logo-link nhsd-o-global-header__logo" id="nhsd-global-header__logo">
                <svg
                    class="nhsd-a-logo"
      ...
      c1.6,0,2.8,0.5,3.6,1.9h0v-1.6L32.6,42.9z M29.5,48.7c0-2-0.8-3.7-2.6-3.7c-2.1,0-2.8,1.9-2.8,3.7c0,1.6,0.8,3.6,2.6,3.6C28.7,52.3,29.5,50.7,29.5,48.7"/>
              ...
              <div class="nhsd-o-global-header__product-name">Design System</div>
            </div>
          </div>
        </div>
      </div>
